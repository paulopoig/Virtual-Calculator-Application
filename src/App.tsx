...
const buttonPress = (symbol: string) => {
  if(symbol === 'clear'){
    ...
    // If last number already has a decimal, don't add number
...
const calculate = () => {
  // If last character is an operator and do nothing
  if(isOperator(et.charAt(et.length - 1))) return;
  // Clean the expressions so that two operators in the row use the last operator
  ...
  return (
    ...
    <div className='container'>
      <h1>Virtual Calculator Application</h1>
      <div id="calculator">
        <div id="display" style={{textAlign: "right"}}>
          <div id="answer">{answer}{expression}</div>
